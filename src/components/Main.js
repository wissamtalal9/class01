...
class Main extends Component {
    render() {
        let users=[{ header4 , ImgUrl:"http://3.bp.blogspot.com/_DBYF1AdFaHw/TE-f0cDQ24I/AAAAAAAACZg/l-FdTZ6M7z8/s1600/Unicorn_and_Narwhal_by_dinglehopper.jpg",title:"UniWhal",desription:"A unicorn and a narwhal nuzzling their horns",keyword:"narwhal",horns:1},
        ...
        return (
                <>
                    ...
                    {
                        users.map(element=>{
                            return <UserData header4={element.header4} ImgUrl={element.ImgUrl} title={element.title} desription={element.desription} keyword={element.keyword}  horns = {element.horns}/>
                            })
                    }
